...
# Make output folder
if(dir.exists("Luminal_Cohort_Results")){
  print("Directory Luminal_Cohort_Results already exists!")
}else{
  dir.create("Luminal_Cohort_Results")
}
...
ggsave(paste0("./Luminal_Cohort_Results/UMAPs_",
...
ggsave(
  filename = paste0("./Luminal_Cohort_Results/",
...
pdf("Luminal_Cohort_Results/EnhancedVolcano_DEGs.pdf",width=10,height=10)
EnhancedVolcano(res,
                lab = rownames(res),
                x = 'log2FoldChange',
                y = 'padj',
...
ggsave(paste0("./Luminal_Cohort_Results/DEGs_",
              "Luminal",".pdf"),
       width = 5,
       height = 5 )
...
saveRDS(up.genes,"./Luminal_Cohort_Results/up_genes.rds")
...
pdf("Luminal_Cohort_Results/GSEA_Luminal_DEGs.pdf",width=10,height=4)
...
saveRDS(resSig,"./Luminal_Cohort_Results/resSig_genes.rds")
...
pdf("Luminal_Cohort_Results/Heatmap_of_DEGs_Luminal.pdf",width=6,height=4)
...
pdf("Luminal_Cohort_Results/EnhancedVolcano_DAPs.pdf",width=10,height=10)
EnhancedVolcano(res,
                lab = rownames(res),
                x = 'log2FoldChange',
                y = 'padj',
...
ggsave(paste0("./Luminal_Cohort_Results/DAPs_",
              "Luminal",".pdf"),
       width = 5,
       height = 5 )
...
saveRDS(up.peaks,"./Luminal_Cohort_Results/up_peaks.rds")

# Plot heatmap of degs using rlog values

resSig = res[ which(res$padj < 0.05 & abs(res$log2FoldChange) > 0.58), ]
saveRDS(resSig,"./Luminal_Cohort_Results/resSig_peaks.rds")
allSig_genes <- rownames(resSig)
...
pdf("Luminal_Cohort_Results/Heatmap_of_DAPs_Luminal.pdf",width=6,height=4)
ComplexHeatmap::Heatmap(t(scale(t(mat[allSig_genes,]))),cluster_rows = T,cluster_columns = TRUE)
dev.off()
...
up.genes <- readRDS("./Luminal_Cohort_Results/up_genes.rds")
up.peaks <- readRDS("./Luminal_Cohort_Results/up_peaks.rds")
...
saveRDS(p2g,"./Luminal_Cohort_Results/p2gs_univariate-prefilter.rds")
...
saveRDS(p2g,"./Luminal_Cohort_Results/p2gs_univariate-postfilter.rds")
...
ggsave("./Luminal_Cohort_Results/peakType_proportionBarchart-univariate.pdf",width = 4, height = 4)
...
ggsave("./Luminal_Cohort_Results/encode_proportionBarchart-univariate.pdf",width = 4,height = 4)
...
pdf("Luminal_Cohort_Results/peakType_and_ENCODE_overlap_proportion_bar_charts.pdf",width=7,height=4)
cowplot::plot_grid(peakTypePropUni,encodePropUni, ncol = 2, nrow = 1)
dev.off()

pdf("Luminal_Cohort_Results/peakType_and_ENCODE_overlap_proportion_bar_charts-NoLegend.pdf",width=5,height=4)
...
saveRDS(p2g,"./Luminal_Cohort_Results/p2gs_interaction.rds")
...
ggsave("./Luminal_Cohort_Results/peakType_proportionBarchart-interaction.pdf",width = 4, height = 4)
...
ggsave("./Luminal_Cohort_Results/encode_proportionBarchart-interaction.pdf",width = 4,height = 4)
...
pdf("Luminal_Cohort_Results/p2g_scatter_plots_and_DiffClass_proportion_bar_chart.pdf",width=24,height=6)
cowplot::plot_grid(p2gScatterDensity, p2gScatterBoth, p2gScatterDiffClass, p2gPropDiffClass, ncol = 4, nrow = 1)
dev.off()

pdf("Luminal_Cohort_Results/p2g_scatter_plots_and_DiffClass_proportion_bar_chart-NoLegend.pdf",width=20,height=6)
...
# pdf("Luminal_Cohort_Results/Significant_Differential_P2Gs-Heatmap.pdf",width=8,height=16)
...
saveRDS(p2g,"./Luminal_Cohort_Results/p2gs_interaction-+_0.rds")

# Screen for up genes
p2g.up.gene <- p2g[p2g$LME_cell_type_1_model_geneName %in% up.genes$gene,]

saveRDS(p2g.up.gene,"./Luminal_Cohort_Results/p2gs_interaction-+_0-upgenes.rds")
...
pdf("Luminal_Cohort_Results/Significant_Differential_P2Gs-Heatmap_+_0_upgenes.pdf",width=4.15,height=4.25)
...
pdf("Luminal_Cohort_Results/Significant_Differential_P2Gs_+_0_upgenes.pdf",width=18,height=4)
p1+p2+p3
dev.off()
...
saveRDS(em.p2g.up.gene,"./Luminal_Cohort_Results/em_p2g_up_gene.rds")
...
ggsave("./Luminal_Cohort_Results/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes-DotPlot.pdf", 
       width = 11,
       height = 6)

barplot(em.p2g.up.gene,showCategory=3)+
  ggtitle(paste0(length(unique(p2g.up.gene$LME_cell_type_1_model_geneName))," unique genes"))
ggsave("./Luminal_Cohort_Results/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes-BarPlot_Count.pdf", 
       width = 11,
       height = 6)

mutate(em.p2g.up.gene, qscore = -log(p.adjust, base=10)) %>% 
  barplot(x="qscore",showCategory=3)
ggsave("./Luminal_Cohort_Results/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes-BarPlot_QScore.pdf", 
       width = 11,
       height = 6)
...
saveRDS(p2g.up.gene.up.peak,"./Luminal_Cohort_Results/p2gs_interaction-+_0-upgenes_uppeaks.rds")
...
pdf("Luminal_Cohort_Results/Significant_Differential_P2Gs-Heatmap_+_0_upgenes_uppeaks.pdf",width=4.15,height=4.25)
ht <- ComplexHeatmap::Heatmap(mat, 
                              name = "beta",
                              col = col_fun, 
                              right_annotation = ha, 
...
pdf("Luminal_Cohort_Results/Significant_Differential_P2Gs_+_0_upgenes_uppeaks.pdf",width=18,height=6)
p1+p2+p3
dev.off()
...
saveRDS(em.p2g.up.gene.up.peak,"./Luminal_Cohort_Results/em_p2g_up_gene_up_peak.rds")
...
ggsave("./Luminal_Cohort_Results/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes_uppeaks-DotPlot.pdf", 
       width = 11,
       height = 6)

barplot(em.p2g.up.gene.up.peak,showCategory=3)+
  ggtitle(paste0(length(unique(p2g.up.gene.up.peak$LME_cell_type_1_model_geneName))," unique genes"))
ggsave("./Luminal_Cohort_Results/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes_uppeaks-BarPlot_Count.pdf", 
       width = 11,
       height = 6)

mutate(em.p2g.up.gene.up.peak, qscore = -log(p.adjust, base=10)) %>% 
  barplot(x="qscore",showCategory=3)
ggsave("./Luminal_Cohort_Results/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes_uppeaks-BarPlot_QScore.pdf", 
       width = 11,
       height = 6)
...
plotP2Gs <- function(ArchRProj, 
  ...
  pdf(paste0(outpath,"P2G_Condition_and_Patient_BrowserTracks_ExpressionBoxPlots_ScatterPlots-",
  ...
  pdf(paste0(outpath,"P2G_Condition_BrowserTracks_ExpressionBoxPlots_ScatterPlots-",
  ...
  pdf(paste0(outpath,"P2G_Patient_BrowserTracks_ExpressionBoxPlots_ScatterPlots-",
...
seurat <- readRDS("Processed_Seurat_Objects_scRNA/Processed_Seurat_Object_Luminal_TN_Subset-TESTING.rds")
seurat <- seurat[,seurat$orig.ident != "3B3E9L"]
seurat$Patient <- ifelse(seurat$orig.ident %in% c("43E7CL","43E7BL"),"43E7BL_43E7CL",seurat$orig.ident)
seurat$Patient <- plyr::mapvalues(x = seurat$Patient,
                                  from = levels(factor(seurat$Patient)),
                                  to = c("1-35EE8L",
                                         "2-3821AL",
                                         "3-3C7D1L",
                                         "6-3D388L",
...
seurat$Condition <- ifelse(seurat$orig.ident %in% c("49758L","49CFCL","4AF75L","4B146L"),"2-Normal","1-Cancer")

# Read in diff P2Gs with up genes
p2g <- readRDS("./Luminal_Cohort_Results/p2gs_interaction-+_0-upgenes.rds")
...
cancerSpecificEnh <- readRDS("./Luminal_Cohort_Results/p2gs_interaction-+_0-upgenes.rds")
...
allP2Gs <- readRDS("./Luminal_Cohort_Results/p2gs_univariate-postfilter.rds")
...
outpath = "./Luminal_Cohort_Results/"
