...
################################################################################
# Make cellsToUse
cellsToUse <- proj$cellNames

# Make cancer normal status
proj$subtype <- ifelse(proj$Sample %in% c("SUM149PT","HCC1143"),"Basal","Luminal")
...
meta_cell_data <- getMetaCells( ArchRProj = proj ,
                                ...
                                compareGroup1 = "Basal",
                                compareGroup2 = "Luminal"
                                )
saveRDS(meta_cell_data,"./LME_CellLines_out-SingFits_OLS/meta_cell_data.rds")
...
saveRDS(p2gs_to_test,"./LME_CellLines_out-SingFits_OLS/p2gs_to_test-metacells.rds")
...
runDiffLME_alt(peak_mat = ATAC,
               ...
               meta_cells = TRUE,
               cores = 96,
               out_path = "LME_CellLines_out-SingFits_OLS",
               id = "metacells")
end <- Sys.time()
