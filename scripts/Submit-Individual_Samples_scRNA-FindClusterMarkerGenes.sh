#!/usr/bin/env bash
#SBATCH --job-name Submit-Individual_Samples_scRNA-FindClusterMarkerGenes
#SBATCH --cpus-per-task 1
#SBATCH -c 1
#SBATCH --mem 4g
#SBATCH --partition allnodes
#SBATCH --output scripts/Submit-Individual_Samples_scRNA-FindClusterMarkerGenes.out 
