...
Tumors.combined <- merge(Her2combinedNov2019,y=c(LumAcombinedNov2020,LumBcombinedNov2019,BasalTrainingdataset2020,rna))
...
finalm.sweep.t <- finalm.sweep.t[rownames(finalm.sweep.t) %in% colnames(rna),]
...
saveRDS(rna,paste0("Processed_Seurat_Objects_scRNA/Processed_Seurat_Object_",ID,"-MultiKClustering-SCSubtype.rds"))
