#!/usr/bin/env bash
#SBATCH --job-name Submit-Individual_Samples_scRNA-SCSubtype_Classification
#SBATCH --cpus-per-task 1
#SBATCH -c 1
#SBATCH --mem 4g
#SBATCH --partition allnodes
#SBATCH --output scripts/Submit-Individual_Samples_scRNA-SCSubtype_Classification.out 
...
do
    jobfile=scripts/Individual_Samples_scRNA-SCSubtype_Classification-${i}.sh
    cat <<EOF > $jobfile
#!/usr/bin/env bash
#SBATCH --job-name Individual_Samples_scRNA-SCSubtype_Classification-${i}
#SBATCH -c 16
#SBATCH --mem 192g
#SBATCH --partition allnodes
#SBATCH --output scripts/Individual_Samples_scRNA-SCSubtype_Classification-${i}.out 
...
singularity exec --bind /datastore \\
                 ...
                 R CMD BATCH '--args ${i}' scripts/Individual_Samples_scRNA-SCSubtype_Classification.R scripts/Individual_Samples_scRNA-SCSubtype_Classification-${i}.Rout
EOF
    chmod +x ${jobfile}
