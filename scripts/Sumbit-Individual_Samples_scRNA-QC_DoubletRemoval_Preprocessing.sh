#!/usr/bin/env bash
#SBATCH --job-name Sumbit-Individual_Samples_scRNA-QC_DoubletRemoval_Preprocessing
#SBATCH --cpus-per-task 1
#SBATCH -c 1
#SBATCH --mem 4g
#SBATCH --partition allnodes
#SBATCH --output scripts/Sumbit-Individual_Samples_scRNA-QC_DoubletRemoval_Preprocessing.out 
