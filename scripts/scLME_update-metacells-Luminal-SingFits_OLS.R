...
saveRDS(meta_cell_data,"./LME_Luminal_out-SingFits_OLS/meta_cell_data.rds")
...
saveRDS(p2gs_to_test,"./LME_Luminal_out-SingFits_OLS/p2gs_to_test-metacells.rds")
...
runDiffLME_alt(peak_mat = ATAC,
               ...
               meta_cells = TRUE,
               cores = 96,
               out_path = "LME_Luminal_out-SingFits_OLS",
               id = "metacells")
end <- Sys.time()
