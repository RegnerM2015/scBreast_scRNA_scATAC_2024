...
if(dir.exists("Cell_Line_Cohort_Results")==TRUE){
  print("Directory Cell_Line_Cohort_Results already exists!")
}else{
  dir.create("Cell_Line_Cohort_Results")
}
...
ggsave(paste0("./Cell_Line_Cohort_Results/UMAPs_",
              "CellLines",".pdf"),
       width = 14,
       height = 6 )
...
ggsave("./Cell_Line_Cohort_Results/QC_Histograms_RNA_ATAC.pdf",width = 9,height = 8)
...
saveRDS(p2g,"./Cell_Line_Cohort_Results/p2gs_univariate-prefilter.rds")

p2g <- p2g[p2g$DiffClass != "0/0",]

saveRDS(p2g,"./Cell_Line_Cohort_Results/p2gs_univariate-postfilter.rds")
...
ggsave("./Cell_Line_Cohort_Results/peakType_proportionBarchart-univariate.pdf",width = 4, height = 4)
...
ggsave("./Cell_Line_Cohort_Results/encode_proportionBarchart-univariate.pdf",width = 4,height = 4)
...
pdf("Cell_Line_Cohort_Results/peakType_and_ENCODE_overlap_proportion_bar_charts.pdf",width=7,height=4)
cowplot::plot_grid(peakTypePropUni,encodePropUni, ncol = 2, nrow = 1)
dev.off()

pdf("Cell_Line_Cohort_Results/peakType_and_ENCODE_overlap_proportion_bar_charts-NoLegend.pdf",width=5,height=4)
...
clP2Gs <- readRDS("./Cell_Line_Cohort_Results/p2gs_univariate-postfilter.rds")
...
makePlots(group1ArchRProj = proj.cl,
           ...
           outPath1 = "./Cell_Line_Cohort_Results/Basal_Cancer_Patients-Basal_Cell_Lines-P2G_Overlaps.pdf",
           outPath2 = "./Cell_Line_Cohort_Results/Basal_Cancer_Patients-Basal_Cell_Lines-PeakSet_Overlaps.pdf",
           outPath3 = "./Cell_Line_Cohort_Results/Basal_Cancer_Patients-Basal_Cell_Lines-em_gene.rds",
           outPath4 = "./Cell_Line_Cohort_Results/Basal_Cancer_Patients-Basal_Cell_Lines-GeneSet_ORA_Hallmark_MSigDB-Shared_Genes-DotPlot.pdf",
           outPath5 = "./Cell_Line_Cohort_Results/Basal_Cancer_Patients-Basal_Cell_Lines-GeneSet_ORA_with_GenesPerPeak_and_PeaksPerGene_Histograms_and_Bar_Charts-NoLegend.pdf",
           outPath6 = "./Cell_Line_Cohort_Results/Basal_Cancer_Patients-Basal_Cell_Lines-GeneSet_ORA_with_GenesPerPeak_and_PeaksPerGene_Histograms_and_Bar_Charts.pdf",
...
makePlots(group1ArchRProj = proj.cl,
           ...
           outPath1 = "./Cell_Line_Cohort_Results/Luminal_Cancer_Patients-Luminal_Cell_Lines-P2G_Overlaps.pdf",
           outPath2 = "./Cell_Line_Cohort_Results/Luminal_Cancer_Patients-Luminal_Cell_Lines-PeakSet_Overlaps.pdf",
           outPath3 = "./Cell_Line_Cohort_Results/Luminal_Cancer_Patients-Luminal_Cell_Lines-em_gene.rds",
           outPath4 = "./Cell_Line_Cohort_Results/Luminal_Cancer_Patients-Luminal_Cell_Lines-GeneSet_ORA_Hallmark_MSigDB-Shared_Genes-DotPlot.pdf",
           outPath5 = "./Cell_Line_Cohort_Results/Luminal_Cancer_Patients-Luminal_Cell_Lines-GeneSet_ORA_with_GenesPerPeak_and_PeaksPerGene_Histograms_and_Bar_Charts-NoLegend.pdf",
           outPath6 = "./Cell_Line_Cohort_Results/Luminal_Cancer_Patients-Luminal_Cell_Lines-GeneSet_ORA_with_GenesPerPeak_and_PeaksPerGene_Histograms_and_Bar_Charts.pdf",
           metaPath1 = "./LME_CellLines_out-SingFits_OLS/meta_cell_data.rds",
