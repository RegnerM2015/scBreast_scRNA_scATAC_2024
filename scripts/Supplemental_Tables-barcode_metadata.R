...
# Make output folder
if(dir.exists("Supplemental_Tables-barcode_metadata")==TRUE){
  print("Directory Supplemental_Tables-barcode_metadata already exists!")
}else{
  dir.create("Supplemental_Tables-barcode_metadata")
}
...
cowplot::plot_grid(p1,
                   ...
                   p6,
                   ncol = 3, nrow = 2)
ggsave("./Supplemental_Tables-barcode_metadata/Full_Cohort_scRNA_UMAP_check.pdf",width=16,height=9)
...
cowplot::plot_grid(p1,
                   ...
                   p6,
                   ncol = 3, nrow = 2)
ggsave("./Supplemental_Tables-barcode_metadata/Basal_Cohort_scRNA_UMAP_check.pdf",width=16,height=9)
...
cowplot::plot_grid(p1,
                   ...
                   p6,
                   ncol = 3, nrow = 2)
ggsave("./Supplemental_Tables-barcode_metadata/Luminal_Cohort_scRNA_UMAP_check.pdf",width=16,height=9)

# Cell Line Cohort
p1 <- ggplot(cl_cohort_rna_metadata,aes(UMAP_1,UMAP_2,color=cell_line))+geom_point(size=0.1)+theme_classic()
cowplot::plot_grid(p1,
                   ncol = 1, nrow = 1)
ggsave("./Supplemental_Tables-barcode_metadata/Cell_Line_Cohort_scRNA_UMAP_check.pdf",width=6,height=6)
...
excel <- writexl::write_xlsx(x = list("Full_Cohort_barcode_meta" = full_cohort_rna_metadata,
                             ...
                             path = "./Supplemental_Tables-barcode_metadata/scRNA_barcode_metadata.xlsx")
...
cowplot::plot_grid(p1,
                   ...
                   p5,
                   ncol = 3, nrow = 2)
ggsave("./Supplemental_Tables-barcode_metadata/Full_Cohort_scATAC_UMAP_check.pdf",width=16,height=9)
...
cowplot::plot_grid(p1,
                   ...
                   p5,
                   ncol = 3, nrow = 2)
ggsave("./Supplemental_Tables-barcode_metadata/Basal_Cohort_scATAC_UMAP_check.pdf",width=16,height=9)
...
cowplot::plot_grid(p1,
                   ...
                   p5,
                   ncol = 3, nrow = 2)
ggsave("./Supplemental_Tables-barcode_metadata/Luminal_Cohort_scATAC_UMAP_check.pdf",width=16,height=9)

# Cell Line Cohort
p1 <- ggplot(cl_cohort_atac_metadata,aes(UMAP_1,UMAP_2,color=cell_line))+geom_point(size=0.1)+theme_classic()
cowplot::plot_grid(p1,
                   ncol = 1, nrow = 1)
ggsave("./Supplemental_Tables-barcode_metadata/Cell_Line_Cohort_scATAC_UMAP_check.pdf",width=6,height=6)
...
excel <- writexl::write_xlsx(x = list("Full_Cohort_barcode_meta" = full_cohort_atac_metadata,
                             ...
                             path = "./Supplemental_Tables-barcode_metadata/scATAC_barcode_metadata.xlsx")
