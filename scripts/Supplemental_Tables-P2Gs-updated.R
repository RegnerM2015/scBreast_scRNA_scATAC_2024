...
if(dir.exists("Supplemental_Tables-P2Gs-updated")==TRUE){
  print("Directory Supplemental_Tables-P2Gs-updated already exists!")
}else{
  dir.create("Supplemental_Tables-P2Gs-updated")
}
...
# Read in Basal P2Gs
p2g <- readRDS("./Basal_Cohort_Results-updates-Revised-updated/p2gs_univariate-postfilter.rds")
p2gInteraction <-  readRDS("./Basal_Cohort_Results-updates-Revised-updated/p2gs_interaction.rds")
diffGenes <- as.data.frame(readRDS("./Basal_Cohort_Results-updates-Revised-updated/resSig_genes.rds"))
diffGenes$geneName <- rownames(diffGenes)
diffPeaks <- as.data.frame(readRDS("./Basal_Cohort_Results-updates-Revised-updated/resSig_peaks.rds"))
...
writeP2Gs(p2g=p2g,
          ...
          diffGenes = diffGenes,
          diffPeaks = diffPeaks,
          csvPath1 = "./Supplemental_Tables-P2Gs-updated/Basal_Cohort_P2Gs.csv",
          csvPath2 = "./Supplemental_Tables-P2Gs-updated/Basal_Cohort_P2G_Quantities-Univariate_by_Normal_Cancer_Shared.csv",
          csvPath3 = "./Supplemental_Tables-P2Gs-updated/Basal_Cohort_P2G_Quantities-Interaction_by_Normal_Cancer_Shared.csv",
          csvPath4 = "./Supplemental_Tables-P2Gs-updated/Basal_Cohort_P2G_Quantities-Interaction_by_DiffClass.csv",
          barchartPath="./Supplemental_Tables-P2Gs-updated/Basal_Cohort_Barchart_Check.pdf")

# Read in Luminal P2Gs
p2g <- readRDS("./Luminal_Cohort_Results-updates-Revised-updated/p2gs_univariate-postfilter.rds")
p2gInteraction <-  readRDS("./Luminal_Cohort_Results-updates-Revised-updated/p2gs_interaction.rds")
diffGenes <- as.data.frame(readRDS("./Luminal_Cohort_Results-updates-Revised-updated/resSig_genes.rds"))
diffGenes$geneName <- rownames(diffGenes)
diffPeaks <- as.data.frame(readRDS("./Luminal_Cohort_Results-updates-Revised-updated/resSig_peaks.rds"))
diffPeaks$peakName <- rownames(diffPeaks)
writeP2Gs(p2g=p2g,
          p2gInteraction = p2gInteraction,
          encode=encode,
          ...
          diffGenes = diffGenes,
          diffPeaks = diffPeaks,
          csvPath1 = "./Supplemental_Tables-P2Gs-updated/Luminal_Cohort_P2Gs.csv",
          csvPath2 = "./Supplemental_Tables-P2Gs-updated/Luminal_Cohort_P2G_Quantities-Univariate_by_Normal_Cancer_Shared.csv",
          csvPath3 = "./Supplemental_Tables-P2Gs-updated/Luminal_Cohort_P2G_Quantities-Interaction_by_Normal_Cancer_Shared.csv",
          csvPath4 = "./Supplemental_Tables-P2Gs-updated/Luminal_Cohort_P2G_Quantities-Interaction_by_DiffClass.csv",
          barchartPath="./Supplemental_Tables-P2Gs-updated/Luminal_Cohort_Barchart_Check.pdf")

# Read in cell line P2Gs
p2g <- readRDS("./Cell_Line_Cohort_Results-Revised/p2gs_univariate-postfilter.rds")
writeP2Gs(p2g=p2g,
          p2gInteraction = NULL,
          encode=encode,
          ...
          diffGenes = NULL,
          diffPeaks = NULL,
          csvPath1 = "./Supplemental_Tables-P2Gs-updated/Cell_Line_Cohort_P2Gs.csv",
          csvPath2 = "./Supplemental_Tables-P2Gs-updated/Cell_Line_Cohort_P2G_Quantities-Univariate_by_Normal_Cancer_Shared.csv",
          csvPath3 = "./Supplemental_Tables-P2Gs-updated/Cell_Line_Cohort_P2G_Quantities-Interaction_by_Normal_Cancer_Shared.csv",
          csvPath4 = "./Supplemental_Tables-P2Gs-updated/Cell_Line_Cohort_P2G_Quantities-Interaction_by_DiffClass.csv",
          barchartPath="./Supplemental_Tables-P2Gs-updated/Cell_Line_Cohort_Barchart_Check.pdf")
