...
# Make output folder
if(dir.exists("Luminal_Cohort_Results-updates")){
  print("Directory Luminal_Cohort_Results-updates already exists!")
}else{
  dir.create("Luminal_Cohort_Results-updates")
}
...
ggsave(paste0("./Luminal_Cohort_Results-updates/UMAPs_",
...
ggsave(
  filename = paste0("./Luminal_Cohort_Results-updates/",
...
# Write out dds
saveRDS(dds,"./Luminal_Cohort_Results-updates/pseudobulk_expression_dds.rds")
...
pdf("Luminal_Cohort_Results-updates/EnhancedVolcano_DEGs.pdf",width=10,height=10)
EnhancedVolcano(res,
                lab = rownames(res),
                x = 'log2FoldChange',
                y = 'padj',
...
saveRDS(degs,paste0("./Luminal_Cohort_Results-updates/DEGs_padj_",padj_cutoff,"_log2FC_",log2fc_cutoff,".rds"))

## Extract normalized counts from dds object
normalized_counts <- counts(dds, normalized = TRUE)
saveRDS(normalized_counts,"./Luminal_Cohort_Results-updates/pseudobulk_expression_normalized_counts.rds")
...
ggsave(paste0("./Luminal_Cohort_Results-updates/DEGs_",
              "Luminal",".pdf"),
       width = 5,
       height = 5 )
...
saveRDS(up.genes,"./Luminal_Cohort_Results-updates/up_genes.rds")
...
pdf("Luminal_Cohort_Results-updates/GSEA_Luminal_DEGs.pdf",width=10,height=4)
...
saveRDS(resSig,"./Luminal_Cohort_Results-updates/resSig_genes.rds")
...
pdf("Luminal_Cohort_Results-updates/Heatmap_of_DEGs_Luminal.pdf",width=6,height=4)
...
# Write out dds
saveRDS(dds,"./Luminal_Cohort_Results-updates/pseudobulk_accessibility_dds.rds")
...
pdf("Luminal_Cohort_Results-updates/EnhancedVolcano_DAPs.pdf",width=10,height=10)
EnhancedVolcano(res,
                lab = rownames(res),
                x = 'log2FoldChange',
                y = 'padj',
...
saveRDS(daps,paste0("./Luminal_Cohort_Results-updates/DAPs_padj_",padj_cutoff,"_log2FC_",log2fc_cutoff,".rds"))

## Extract normalized counts from dds object
normalized_counts <- counts(dds, normalized = TRUE)
saveRDS(normalized_counts,"./Luminal_Cohort_Results-updates/pseudobulk_accessibility_normalized_counts.rds")
...
ggsave(paste0("./Luminal_Cohort_Results-updates/DAPs_",
              "Luminal",".pdf"),
       width = 5,
       height = 5 )
...
saveRDS(up.peaks,"./Luminal_Cohort_Results-updates/up_peaks.rds")

# Plot heatmap of degs using rlog values

resSig = res[ which(res$padj < 0.05 & abs(res$log2FoldChange) > 0.58), ]
saveRDS(resSig,"./Luminal_Cohort_Results-updates/resSig_peaks.rds")
allSig_genes <- rownames(resSig)
...
pdf("Luminal_Cohort_Results-updates/Heatmap_of_DAPs_Luminal.pdf",width=6,height=4)
ComplexHeatmap::Heatmap(t(scale(t(mat[allSig_genes,]))),cluster_rows = T,cluster_columns = TRUE)
dev.off()
...
up.genes <- readRDS("./Luminal_Cohort_Results-updates/up_genes.rds")
up.peaks <- readRDS("./Luminal_Cohort_Results-updates/up_peaks.rds")
...
saveRDS(p2g,"./Luminal_Cohort_Results-updates/p2gs_univariate-prefilter.rds")
...
saveRDS(p2g,"./Luminal_Cohort_Results-updates/p2gs_univariate-postfilter.rds")
...
ggsave("./Luminal_Cohort_Results-updates/peakType_proportionBarchart-univariate.pdf",width = 4, height = 4)
...
ggsave("./Luminal_Cohort_Results-updates/encode_proportionBarchart-univariate.pdf",width = 4,height = 4)
...
pdf("Luminal_Cohort_Results-updates/peakType_and_ENCODE_overlap_proportion_bar_charts.pdf",width=7,height=4)
cowplot::plot_grid(peakTypePropUni,encodePropUni, ncol = 2, nrow = 1)
dev.off()

pdf("Luminal_Cohort_Results-updates/peakType_and_ENCODE_overlap_proportion_bar_charts-NoLegend.pdf",width=5,height=4)
...
saveRDS(p2g,"./Luminal_Cohort_Results-updates/p2gs_interaction.rds")
...
ggsave("./Luminal_Cohort_Results-updates/peakType_proportionBarchart-interaction.pdf",width = 4, height = 4)
...
ggsave("./Luminal_Cohort_Results-updates/encode_proportionBarchart-interaction.pdf",width = 4,height = 4)
...
# Diff P2G scatter plots and proportion bar chart
p2gScatterDensity <- ggplot(p2g,aes(LME_cell_type_1_model_peak_effect_size,
                                    LME_cell_type_2_model_peak_effect_size))+geom_hex(bins = 300) +
...
p2gScatterDiffClass <- ggplot(p2g,aes(LME_cell_type_1_model_peak_effect_size,
                                      LME_cell_type_2_model_peak_effect_size,
                                      color=DiffClass))+geom_point(size=0.25,alpha=0.5)+
  theme_bw()+
  xlab(expression("P2G" ~ beta ~ "effect size in cancer univariate model"))+
  ylab(expression("P2G" ~ beta ~ "effect size in normal univariate model"))+
  guides(colour = guide_legend(override.aes = list(size=3)))+
...
p2g$plot <- "DiffClass"
df <- p2g %>% dplyr::group_by_at("plot") %>% dplyr::count(DiffClass)
colnames(df) <- c("plot","DiffClass","Cells")
p2gPropDiffClass <- df %>%
  ggplot(aes(fill=DiffClass, y=Cells, x= plot))+
  geom_bar(position="fill", stat="identity")+theme_classic()+ylab("Fraction of P2Gs")+
  scale_fill_manual(values=c(cols[3],cols[4],
                             cols[1],cols[2],
                             cols[5],cols[6],
                             cols[7],cols[8]))+
  ggtitle(paste(nrow(p2g)," significant differential P2Gs"))

pdf("Luminal_Cohort_Results-updates/p2g_scatter_plots_and_DiffClass_proportion_bar_chart.pdf",width=24,height=6)
cowplot::plot_grid(p2gScatterDensity, p2gScatterBoth, p2gScatterDiffClass, p2gPropDiffClass, ncol = 4, nrow = 1)
dev.off()

pdf("Luminal_Cohort_Results-updates/p2g_scatter_plots_and_DiffClass_proportion_bar_chart-NoLegend.pdf",width=20,height=6)
cowplot::plot_grid(p2gScatterDensity+NoLegend(), 
                   p2gScatterBoth+NoLegend(), 
                   p2gScatterDiffClass+NoLegend(), 
                   p2gPropDiffClass+NoLegend(), ncol = 4, nrow = 1)
dev.off()
...
# pdf("Luminal_Cohort_Results-updates/Significant_Differential_P2Gs-Heatmap.pdf",width=8,height=16)
...
saveRDS(p2g,"./Luminal_Cohort_Results-updates/p2gs_interaction-+_0.rds")

# Screen for up genes
p2g.up.gene <- p2g[p2g$LME_cell_type_1_model_geneName %in% up.genes$gene,]

saveRDS(p2g.up.gene,"./Luminal_Cohort_Results-updates/p2gs_interaction-+_0-upgenes.rds")
...
pdf("Luminal_Cohort_Results-updates/Significant_Differential_P2Gs-Heatmap_+_0_upgenes.pdf",width=4.15,height=4.25)
...
pdf("Luminal_Cohort_Results-updates/Significant_Differential_P2Gs_+_0_upgenes.pdf",width=18,height=4)
p1+p2+p3
dev.off()
...
saveRDS(em.p2g.up.gene,"./Luminal_Cohort_Results-updates/em_p2g_up_gene.rds")
...
ggsave("./Luminal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes-DotPlot.pdf", 
       width = 11,
       height = 6)

barplot(em.p2g.up.gene,showCategory=3)+
  ggtitle(paste0(length(unique(p2g.up.gene$LME_cell_type_1_model_geneName))," unique genes"))
ggsave("./Luminal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes-BarPlot_Count.pdf", 
       width = 11,
       height = 6)

mutate(em.p2g.up.gene, qscore = -log(p.adjust, base=10)) %>% 
  barplot(x="qscore",showCategory=3)
ggsave("./Luminal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes-BarPlot_QScore.pdf", 
       width = 11,
       height = 6)
...
saveRDS(p2g.up.gene.up.peak,"./Luminal_Cohort_Results-updates/p2gs_interaction-+_0-upgenes_uppeaks.rds")
...
pdf("Luminal_Cohort_Results-updates/Significant_Differential_P2Gs-Heatmap_+_0_upgenes_uppeaks.pdf",width=4.15,height=4.25)
ht <- ComplexHeatmap::Heatmap(mat, 
                              name = "beta",
                              col = col_fun, 
                              right_annotation = ha, 
...
pdf("Luminal_Cohort_Results-updates/Significant_Differential_P2Gs_+_0_upgenes_uppeaks.pdf",width=18,height=6)
p1+p2+p3
dev.off()
...
saveRDS(em.p2g.up.gene.up.peak,"./Luminal_Cohort_Results-updates/em_p2g_up_gene_up_peak.rds")
...
ggsave("./Luminal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes_uppeaks-DotPlot.pdf", 
       width = 11,
       height = 6)

barplot(em.p2g.up.gene.up.peak,showCategory=3)+
  ggtitle(paste0(length(unique(p2g.up.gene.up.peak$LME_cell_type_1_model_geneName))," unique genes"))
ggsave("./Luminal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes_uppeaks-BarPlot_Count.pdf", 
       width = 11,
       height = 6)

mutate(em.p2g.up.gene.up.peak, qscore = -log(p.adjust, base=10)) %>% 
  barplot(x="qscore",showCategory=3)
ggsave("./Luminal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes_uppeaks-BarPlot_QScore.pdf", 
       width = 11,
       height = 6)
...
# Read in dds 
dds <- readRDS("./Luminal_Cohort_Results-updates/pseudobulk_expression_dds.rds")
...
p2g <- readRDS("./Luminal_Cohort_Results-updates/p2gs_interaction-+_0-upgenes.rds")
...
cancerSpecificEnh <- readRDS("./Luminal_Cohort_Results-updates/p2gs_interaction-+_0-upgenes.rds")
...
allP2Gs <- readRDS("./Luminal_Cohort_Results-updates/p2gs_univariate-postfilter.rds")
...
# Establish patient factor levels
allLevels <- c("49758L",
               "49CFCL",
               "4AF75L",
               "4B146L",
...
outpath = "./Luminal_Cohort_Results-updates/"
...
# Plots for HSH11B1L (highest effect size)
plotP2Gs(ArchRProj = proj, 
         p2g = p2g.crabp2.high,
         meta_cell_data = meta_cell_data,
         encode.gr = encode.gr,
