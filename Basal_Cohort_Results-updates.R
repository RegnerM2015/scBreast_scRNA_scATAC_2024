...
# Make output folder
if(dir.exists("Basal_Cohort_Results-updates")){
  print("Directory Basal_Cohort_Results-updates already exists!")
}else{
  dir.create("Basal_Cohort_Results-updates")
}
...
ggsave(paste0("./Basal_Cohort_Results-updates/UMAPs_",
...
ggsave(
  filename = paste0("./Basal_Cohort_Results-updates/",
...
# Write out dds
saveRDS(dds,"./Basal_Cohort_Results-updates/pseudobulk_expression_dds.rds")
...
pdf("Basal_Cohort_Results-updates/EnhancedVolcano_DEGs.pdf",width=10,height=10)
EnhancedVolcano(res,
                lab = rownames(res),
                x = 'log2FoldChange',
                y = 'padj',
...
saveRDS(degs,paste0("./Basal_Cohort_Results-updates/DEGs_padj_",padj_cutoff,"_log2FC_",log2fc_cutoff,".rds"))

## Extract normalized counts from dds object
normalized_counts <- counts(dds, normalized = TRUE)
saveRDS(normalized_counts,"./Basal_Cohort_Results-updates/pseudobulk_expression_normalized_counts.rds")
...
ggsave(paste0("./Basal_Cohort_Results-updates/DEGs_",
              "Basal",".pdf"),
       width = 5,
       height = 5 )
...
saveRDS(up.genes,"./Basal_Cohort_Results-updates/up_genes.rds")
...
pdf("Basal_Cohort_Results-updates/GSEA_Basal_DEGs.pdf",width=10,height=4)
...
saveRDS(resSig,"./Basal_Cohort_Results-updates/resSig_genes.rds")
...
pdf("Basal_Cohort_Results-updates/Heatmap_of_DEGs_Basal.pdf",width=6,height=4)
...
# Write out dds
saveRDS(dds,"./Basal_Cohort_Results-updates/pseudobulk_accessibility_dds.rds")
...
pdf("Basal_Cohort_Results-updates/EnhancedVolcano_DAPs.pdf",width=10,height=10)
EnhancedVolcano(res,
                lab = rownames(res),
                x = 'log2FoldChange',
                y = 'padj',
...
saveRDS(daps,paste0("./Basal_Cohort_Results-updates/DAPs_padj_",padj_cutoff,"_log2FC_",log2fc_cutoff,".rds"))

## Extract normalized counts from dds object
normalized_counts <- counts(dds, normalized = TRUE)
saveRDS(normalized_counts,"./Basal_Cohort_Results-updates/pseudobulk_accessibility_normalized_counts.rds")
...
ggsave(paste0("./Basal_Cohort_Results-updates/DAPs_",
              "Basal",".pdf"),
       width = 5,
       height = 5 )
...
saveRDS(up.peaks,"./Basal_Cohort_Results-updates/up_peaks.rds")

# Plot heatmap of degs using rlog values

resSig = res[ which(res$padj < 0.05 & abs(res$log2FoldChange) > 0.58), ]
saveRDS(resSig,"./Basal_Cohort_Results-updates/resSig_peaks.rds")
allSig_genes <- rownames(resSig)
...
pdf("Basal_Cohort_Results-updates/Heatmap_of_DAPs_Basal.pdf",width=6,height=4)
ComplexHeatmap::Heatmap(t(scale(t(mat[allSig_genes,]))),cluster_rows = T,cluster_columns = TRUE)
dev.off()
...
up.genes <- readRDS("./Basal_Cohort_Results-updates/up_genes.rds")
up.peaks <- readRDS("./Basal_Cohort_Results-updates/up_peaks.rds")
...
saveRDS(p2g,"./Basal_Cohort_Results-updates/p2gs_univariate-prefilter.rds")
...
saveRDS(p2g,"./Basal_Cohort_Results-updates/p2gs_univariate-postfilter.rds")
...
ggsave("./Basal_Cohort_Results-updates/peakType_proportionBarchart-univariate.pdf",width = 4, height = 4)
...
ggsave("./Basal_Cohort_Results-updates/encode_proportionBarchart-univariate.pdf",width = 4,height = 4)
...
pdf("Basal_Cohort_Results-updates/peakType_and_ENCODE_overlap_proportion_bar_charts.pdf",width=7,height=4)
cowplot::plot_grid(peakTypePropUni,encodePropUni, ncol = 2, nrow = 1)
dev.off()

pdf("Basal_Cohort_Results-updates/peakType_and_ENCODE_overlap_proportion_bar_charts-NoLegend.pdf",width=5,height=4)
...
saveRDS(p2g,"./Basal_Cohort_Results-updates/p2gs_interaction.rds")
...
ggsave("./Basal_Cohort_Results-updates/peakType_proportionBarchart-interaction.pdf",width = 4, height = 4)
...
ggsave("./Basal_Cohort_Results-updates/encode_proportionBarchart-interaction.pdf",width = 4,height = 4)
...
pdf("Basal_Cohort_Results-updates/p2g_scatter_plots_and_DiffClass_proportion_bar_chart.pdf",width=24,height=6)
cowplot::plot_grid(p2gScatterDensity, p2gScatterBoth, p2gScatterDiffClass, p2gPropDiffClass, ncol = 4, nrow = 1)
dev.off()

pdf("Basal_Cohort_Results-updates/p2g_scatter_plots_and_DiffClass_proportion_bar_chart-NoLegend.pdf",width=20,height=6)
...
# pdf("Basal_Cohort_Results-updates/Significant_Differential_P2Gs-Heatmap.pdf",width=8,height=16)
...
saveRDS(p2g,"./Basal_Cohort_Results-updates/p2gs_interaction-+_0.rds")

# Screen for up genes
p2g.up.gene <- p2g[p2g$LME_cell_type_1_model_geneName %in% up.genes$gene,]

saveRDS(p2g.up.gene,"./Basal_Cohort_Results-updates/p2gs_interaction-+_0-upgenes.rds")
...
pdf("Basal_Cohort_Results-updates/Significant_Differential_P2Gs-Heatmap_+_0_upgenes.pdf",width=4.15,height=5.3)
...
pdf("Basal_Cohort_Results-updates/Significant_Differential_P2Gs_+_0_upgenes.pdf",width=18,height=4)
p1+p2+p3
dev.off()
...
saveRDS(em.p2g.up.gene,"./Basal_Cohort_Results-updates/em_p2g_up_gene.rds")
...
ggsave("./Basal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes-DotPlot.pdf", 
       width = 8,
       height = 6)

barplot(em.p2g.up.gene,showCategory=3)+
  ggtitle(paste0(length(unique(p2g.up.gene$LME_cell_type_1_model_geneName))," unique genes"))
ggsave("./Basal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes-BarPlot_Count.pdf", 
       width = 8,
       height = 6)

mutate(em.p2g.up.gene, qscore = -log(p.adjust, base=10)) %>% 
  barplot(x="qscore",showCategory=3)
ggsave("./Basal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes-BarPlot_QScore.pdf", 
       width = 8,
       height = 6)
...
saveRDS(p2g.up.gene.up.peak,"./Basal_Cohort_Results-updates/p2gs_interaction-+_0-upgenes_uppeaks.rds")
...
pdf("Basal_Cohort_Results-updates/Significant_Differential_P2Gs-Heatmap_+_0_upgenes_uppeaks.pdf",width=4.15,height=5.3)
ht <- ComplexHeatmap::Heatmap(mat, 
                              name = "beta",
                              col = col_fun, 
                              right_annotation = ha, 
...
pdf("Basal_Cohort_Results-updates/Significant_Differential_P2Gs_+_0_upgenes_uppeaks.pdf",width=18,height=6)
p1+p2+p3
dev.off()
...
saveRDS(em.p2g.up.gene.up.peak,"./Basal_Cohort_Results-updates/em_p2g_up_gene_up_peak.rds")
...
ggsave("./Basal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes_uppeaks-DotPlot.pdf")

barplot(em.p2g.up.gene.up.peak,showCategory=3)+
  ggtitle(paste0(length(unique(p2g.up.gene.up.peak$LME_cell_type_1_model_geneName))," unique genes"))
ggsave("./Basal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes_uppeaks-BarPlot_Count.pdf")

mutate(em.p2g.up.gene.up.peak, qscore = -log(p.adjust, base=10)) %>% 
  barplot(x="qscore",showCategory=3)
ggsave("./Basal_Cohort_Results-updates/GeneSet_ORA_Hallmark_MSigDB_+_0_upgenes_uppeaks-BarPlot_QScore.pdf")
...
# Read in dds 
dds <- readRDS("./Basal_Cohort_Results-updates/pseudobulk_expression_dds.rds")
...
p2g <- readRDS("./Basal_Cohort_Results-updates/p2gs_interaction-+_0-upgenes.rds")
...
cancerSpecificEnh <- readRDS("./Basal_Cohort_Results-updates/p2gs_interaction-+_0-upgenes.rds")
cancerSpecificEnh <- cancerSpecificEnh[cancerSpecificEnh$LME_cell_type_1_model_geneName == "HEY1",]

# Read in cancerEnh and normalEnh 
allP2Gs <- readRDS("./Basal_Cohort_Results-updates/p2gs_univariate-postfilter.rds")
...
outpath = "./Basal_Cohort_Results-updates/"
